...
public class ItemController extends BaseController {
    ...
    @ApiOperation(value = "根据分类id搜索商品列表", httpMethod = "GET")
    @GetMapping("catItems")
    public IMOOCJSONResult catItems(
        ...
        PagedGridResult result = itemService
                .searchItemsByCat(catId, sort, page, pageSize);
        return IMOOCJSONResult.ok(result);
    }

    @ApiOperation(value = "根据商品规格ids查找最新的商品数据", httpMethod = "GET")
    @GetMapping("refresh")
    public IMOOCJSONResult refresh(
        ...
        List<ShopcartVO> shopcartVOS = itemService
                .queryItemsBySpecIds(itemSpecIds);
