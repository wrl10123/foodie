...
public class BaseController {
    ...
    public static final String ERROR_IMG_FILE = "图片格式不正确";
    ...
    //微信支付成功 -> 支付中心 -> 天天吃货
    //回调通知的url（需要外网能够访问得到..............）
    public static final String payReturnUrl = "http://api.z.alone-annie.com:8088/foodie-dev-api/orders/notifyMerchantOrderPaid";
